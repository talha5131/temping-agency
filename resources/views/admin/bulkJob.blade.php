    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container">
                    <form id="postAJob" action="{{ route('admin.addBulk')}}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <select name="job1" class="form-control">
                                    ...
                                    <div class="col-sm-5">
                                        <select name="job2" class="form-control">
                                            <option>Select Keyword</option>
                                            @foreach($keys as $key)
                                                <option value="{{$key->name}}">{{ $key->name }}</option>
                                            @endforeach 
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" rows="7" id="meta" name="meta">{{Request::old('meta')}}</textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control job-content" rows="7" id="desc" name="desc">{{Request::old('desc')}}</textarea>
